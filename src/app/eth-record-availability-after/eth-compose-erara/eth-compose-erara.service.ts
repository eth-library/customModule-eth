...
export class EthComposeEraraService {
  ...
  getOnlineEraraRecord(mmsid: string): Observable<any | null> {
  ...
  getEraraRecordForEMap(mmsid: string): Observable<any | null> {
    if (!mmsid) return of(null);
  ...
  getEMapsRecord(mmsid: string): Observable<any | null> {
    if (!mmsid) return of(null);
