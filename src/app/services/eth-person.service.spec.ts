...
describe('EthPersonService', () => {
  ...
  it('requests persons by GND list', () => {
  ...
  it('routes getPerson to QID endpoint', () => {
  ...
  it('routes getPerson to LCCN endpoint', () => {
  ...
  it('routes getPerson to GND endpoint', () => {
  ...
  it('returns null when GND by IdRef is 404', () => {
