...
function applyDesign() {
    ...
    if (design) {
        ...
        // Inject particle background for 'petrol2' design
        if (design === 'petrol2') {
...
function injectParticleBackground() {
    ...
    const interval = setInterval(() => {
        ...
        if (container) {
            ...
            console.log('Custom.js: Container found, injecting particle canvas.');

            if (container.querySelector('#particle-canvas')) return;

            // Do NOT clear content, as it contains the search bar etc.
            // container.innerHTML = ''; 
            ...
            clearInterval(interval);
            console.log('Custom.js: Container for particles not found.');
        }
    }, 500);
}
